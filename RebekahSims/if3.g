...
/*
	...
	addmsg /cell/tertdend1_9/fluorescence /output/plot_out SAVE ratio
*/	
...
call /output/plot_out OUT_OPEN
call /output/plot_out OUT_WRITE "time SomaVm tert1fluo5F tert2fluo5F" //header

int i = 0
float inj =  1000e-12  //990e-12  //640e-12  //280e-12   

float inject, delay, current_duration, total_duration
float start_current = 260e-12
delay= 0.5
