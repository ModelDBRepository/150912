...
//call function
 ...
 function add_output_sec 
    ...
    //addmsg {cellpath}/secdend3/{CA_BUFF_3} /output/plot_out  SAVE Ca  //not hooked up?
	...
	call /output/plot_out OUT_WRITE "time  CaNMDA  	SomaVm" //header
end
...
//add_output is for whatever and can be easily changed
 ...
 function add_output 
	...
	addmsg /cell/secdend11/NR2A/block /output/plot_out SAVE Gk
	//addmsg /cell/secdend11/NR2A/GHK /output/plot_out SAVE Gk
	addmsg /cell/secdend11/AMPA /output/plot_out SAVE Gk
